...
def main():
    ...
    demo_file_name = r"D:/Samihan/Documents/Programming/Python Projects/CSGO Demo Parsing/demos/cloud9-vs-outsiders-m2-ancient.dem"
    ...
    demo_object = models.deserialize_demo_data(data)
    print(demo_object)

    # TODO: Make a game timeline (or something like that)
    # so we can make a list of "events" and use that for analysis
    # did this event precipitate something? what happened after? etc.
